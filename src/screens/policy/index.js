  ...
  return (
    <div>
      <p>
        ...
        <nobr>веб-сайта</nobr>{' '}
        <a href="http://calendaur.com/.">http://calendaur.com/.</a>
        <br />
        2. Основные понятия, используемые в&nbsp;Политике
        <br />
        Автоматизированная обработка персональных данных&nbsp;&mdash; обработка
        ...
        <a href="http://calendaur.com/">http://calendaur.com/</a>;<br />
        ...
        <br />
        Обработка персональных данных&nbsp;&mdash; любое действие (операция) или
        ...
        <br />
        Персональные данные&nbsp;&mdash; любая информация, относящаяся прямо или
        ...
        размещение в&nbsp;<nobr>информационно-телекоммуникационных</nobr> сетях
        ...
        о&nbsp;посетителях (<nobr>в т. ч.</nobr> файлов &laquo;cookie&raquo;)
        с&nbsp;помощью сервисов <nobr>интернет-статистики</nobr> (Яндекс Метрика
        ...
        с&nbsp;пометкой &laquo;Отказ от&nbsp;уведомлениях о&nbsp;новых продуктах
        ...
        <a href="http://calendaur.com/.">http://calendaur.com/.</a> Заполняя
        ...
        <a href="http://calendaur.com/policy">http://calendaur.com/policy</a>.
      </p>
    </div>
  )
}
